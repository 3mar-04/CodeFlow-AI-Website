import { Github, Instagram, Linkedin, Mail, Twitch, X } from "lucide-react";
import React from "react";

const Footer = () => {
  const footerLinks = {
    Products: ["Features", "Pricing", "Security", "Roadmap", "Changelog"],
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
        ...
        <div className="hidden sm:grid sm:grid-cols-3 lg:grid-cols-6 gap-6 sm:gap-8 lg:gap-12 mb-8 sm:mb-12">
          <div className="col-span-1 sm:col-span-3 lg:col-span-2 text-center sm:text-left">
            ...
            <p className="text-gray-400 mb-4 sm:mb-6 max-w-xs mx-auto text-sm sm:text-base">
            ...
            <div className="flex justify-center sm:justify-start space-x-3 sm:space-x-4">
              <a
                href="#"
                className="p-2 sm:p-2.5 bd-slate-800 rounded-lg hover:bg-slate-700 transition-colors duration-200"
              >
          ...
          <div className="sm:col-span-3 lg:col-span-4">
            <div className="grid grid-cols-3 lg:grid-cols-4 gap-6 sm:gap-6 lg:gap-12">
